	...
	this.$delay(function () {
		this.$post("$")
			.success(function (resp) {
				...
				this.metricCards = [
					{key: "clusters", title: "集群", value: this.dashboard.countNodeClusters || 0, extra: ""},
					{
						key: "nodes",
						title: "边缘节点",
						value: this.dashboard.countNodes || 0,
						extra: this.dashboard.countOfflineNodes > 0 ? (this.dashboard.countOfflineNodes + " 离线") : ""
					},
					{
						key: "apiNodes",
						title: "API 节点",
						value: this.dashboard.countAPINodes || 0,
						extra: this.dashboard.countOfflineAPINodes > 0 ? (this.dashboard.countOfflineAPINodes + " 离线") : ""
					},
					{key: "users", title: "用户", value: this.dashboard.countUsers || 0, extra: ""},
					{key: "servers", title: "网站", value: this.dashboard.countServers || 0, extra: ""},
					{key: "uniqueIPs", title: "当天独立 IP", value: this.todayCountIPsFormat, extra: ""},
					{key: "todayTraffic", title: "当天流量", value: this.todayTraffic, extra: this.todayTrafficUnit}
				]
