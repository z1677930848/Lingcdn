...
const (
	...
	PayTypeYiPay  = "yipay"  // 易支付
)

var (
	PayTypeSlice = []string{
		PayTypeWxPay, PayTypeAliPay, PayTypeQQPay, PayTypeYiPay,
	}
...
const (
	...
	// 易支付
	TradeTypeYiWeb = "yipay_web" // PC网页
	TradeTypeYiWap = "yipay_wap" // 移动端
)
...
var (
	...
	TradeTypeYiSlice  = []string{TradeTypeYiWeb, TradeTypeYiWap}
)
...
var PayTypeOptions = []*model.Option{
	...
	dict.GenDefaultOption(PayTypeYiPay, "易支付"),
}
